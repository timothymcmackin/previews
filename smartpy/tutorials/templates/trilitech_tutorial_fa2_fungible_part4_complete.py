# c.f. https://github.com/trilitech/tutorial-applications/tree/main/smartpy_fa2_fungible
...
def test():
    ...
    contract = my_module.MyFungibleContract(
        admin.address, sp.big_map(), initial_ledger, [tok0_md, tok1_md]
    )
    ...
    metadata_uri = "https//example.com"  # sp.pin_on_ipfs(contract_metadata)
    ...
    scenario.verify(_total_supply(contract, sp.record(token_id=2)) == 4)
    ...
    contract.convert(conversions, _sender=alice)
    scenario.verify(
