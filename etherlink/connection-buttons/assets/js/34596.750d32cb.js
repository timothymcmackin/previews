...
const canPromise = __webpack_require__(59414)

const QRCode = __webpack_require__(9474)
const CanvasRenderer = __webpack_require__(50164)
const SvgRenderer = __webpack_require__(34672)
...
const getSymbolSize = (__webpack_require__(58292).getSymbolSize)
...
const Mode = __webpack_require__(8555)
...
const encodeUtf8 = __webpack_require__(62378)
const Mode = __webpack_require__(8555)
...
const ECLevel = __webpack_require__(31141)
...
const Utils = __webpack_require__(58292)
...
const VersionCheck = __webpack_require__(56459)
const Regex = __webpack_require__(25920)
...
const GF = __webpack_require__(10379)
...
const Utils = __webpack_require__(58292)
const ECLevel = __webpack_require__(31141)
const BitBuffer = __webpack_require__(66745)
const BitMatrix = __webpack_require__(52648)
const AlignmentPattern = __webpack_require__(97634)
const FinderPattern = __webpack_require__(32825)
const MaskPattern = __webpack_require__(94042)
const ECCode = __webpack_require__(45427)
const ReedSolomonEncoder = __webpack_require__(21629)
const Version = __webpack_require__(23541)
const FormatInfo = __webpack_require__(91110)
const Mode = __webpack_require__(8555)
const Segments = __webpack_require__(4332)
...
const Polynomial = __webpack_require__(22805)
...
const Mode = __webpack_require__(8555)
const NumericData = __webpack_require__(53787)
const AlphanumericData = __webpack_require__(86044)
const ByteData = __webpack_require__(12488)
const KanjiData = __webpack_require__(90818)
const Regex = __webpack_require__(25920)
const Utils = __webpack_require__(58292)
...
const Utils = __webpack_require__(32287)
...
const PNG = (__webpack_require__(35477)/* .PNG */ .y)
const Utils = __webpack_require__(32287)
...
const svgTagRenderer = __webpack_require__(34672)
...
const big = __webpack_require__(57175)
const small = __webpack_require__(87738)
...
const canPromise = __webpack_require__(59414)
const QRCode = __webpack_require__(9474)
const PngRenderer = __webpack_require__(61953)
const Utf8Renderer = __webpack_require__(24508)
const TerminalRenderer = __webpack_require__(87591)
const SvgRenderer = __webpack_require__(65748)
...
exports.toCanvas = __webpack_require__(5905).toCanvas
...
let interlaceUtils = __webpack_require__(27084);
...
let constants = __webpack_require__(93482);
...
let paethPredictor = __webpack_require__(46744);
...
let util = __webpack_require__(73837);
let ChunkStream = __webpack_require__(38442);
let Filter = __webpack_require__(22769);
...
let SyncReader = __webpack_require__(20033);
let Filter = __webpack_require__(22769);
...
let Stream = __webpack_require__(12781);
let constants = __webpack_require__(93482);
let Packer = __webpack_require__(59432);
...
let constants = __webpack_require__(93482);
let CrcStream = __webpack_require__(47216);
let bitPacker = __webpack_require__(9027);
let filter = __webpack_require__(48876);
let zlib = __webpack_require__(59796);
...
let Parser = __webpack_require__(78550);
let bitmapper = __webpack_require__(9983);
let formatNormaliser = __webpack_require__(58417);
...
let hasSyncZlib = true;
let zlib = __webpack_require__(59796);
let inflateSync = __webpack_require__(69653);
if (!zlib.deflateSync) {
  hasSyncZlib = false;
}
let SyncReader = __webpack_require__(20033);
let FilterSync = __webpack_require__(18692);
let Parser = __webpack_require__(78550);
let bitmapper = __webpack_require__(9983);
let formatNormaliser = __webpack_require__(58417);
...
let constants = __webpack_require__(93482);
let CrcCalculator = __webpack_require__(47216);
...
let parse = __webpack_require__(12416);
let pack = __webpack_require__(58360);
...
let util = __webpack_require__(73837);
let Stream = __webpack_require__(12781);
let Parser = __webpack_require__(57900);
let Packer = __webpack_require__(76838);
let PNGSync = __webpack_require__(76117);
...
// EXTERNAL MODULE: ./node_modules/lit/index.js + 5 modules
var lit = __webpack_require__(33456);
// EXTERNAL MODULE: ./node_modules/lit/decorators.js + 5 modules
var decorators = __webpack_require__(50946);
// EXTERNAL MODULE: ./node_modules/lit-html/node/lit-html.js
var lit_html = __webpack_require__(2144);
...
var dist = __webpack_require__(75740);
...
var lib = __webpack_require__(2039);
...
const styles$t = (0,lit/* css */.iv)`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`;
...
let WcmButton = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.disabled = false;
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<button class="${o(classes)}" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<wcm-text variant="small-regular" color="${textColor}"><slot></slot></wcm-text>${this.iconRight}</button>`;
  }
};
...
WcmButton = __decorateClass$x([
  (0,decorators/* customElement */.Mo)("wcm-button")
], WcmButton);

const styles$s = (0,lit/* css */.iv)`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`;
...
let WcmButtonBig = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.disabled = false;
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<button ?disabled="${this.disabled}" class="${o(classes)}"><slot></slot></button>`;
  }
};
...
WcmButtonBig = __decorateClass$w([
  (0,decorators/* customElement */.Mo)("wcm-button-big")
], WcmButtonBig);

const styles$r = (0,lit/* css */.iv)`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
...
let WcmModalBackcard = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${SvgUtil.WALLET_CONNECT_LOGO} <button @click="${dist/* ModalCtrl */.jb.close}">${SvgUtil.CROSS_ICON}</button></div>`;
  }
};
WcmModalBackcard.styles = [ThemeUtil.globalCss, styles$q];
WcmModalBackcard = __decorateClass$u([
  (0,decorators/* customElement */.Mo)("wcm-modal-backcard")
], WcmModalBackcard);

const styles$p = (0,lit/* css */.iv)`main{padding:20px;padding-top:0;width:100%}`;
...
let WcmModalContent = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<main><slot></slot></main>`;
  }
};
WcmModalContent.styles = [ThemeUtil.globalCss, styles$p];
WcmModalContent = __decorateClass$t([
  (0,decorators/* customElement */.Mo)("wcm-modal-content")
], WcmModalContent);

const styles$o = (0,lit/* css */.iv)`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
...
let WcmModalFooter = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<footer><slot></slot></footer>`;
  }
};
WcmModalFooter.styles = [ThemeUtil.globalCss, styles$o];
WcmModalFooter = __decorateClass$s([
  (0,decorators/* customElement */.Mo)("wcm-modal-footer")
], WcmModalFooter);

const styles$n = (0,lit/* css */.iv)`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
...
let WcmModalHeader = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.title = "";
  ...
  // -- private ------------------------------------------------------ //
  backBtnTemplate() {
    return (0,lit/* html */.dy)`<button class="wcm-back-btn" @click="${dist/* RouterCtrl */.AV.goBack}">${SvgUtil.BACK_ICON}</button>`;
  }
  actionBtnTemplate() {
    return (0,lit/* html */.dy)`<button class="wcm-action-btn" @click="${this.onAction}">${this.actionIcon}</button>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    const classes = {
    ...
    const content = this.title ? (0,lit/* html */.dy)`<wcm-text variant="big-bold">${this.title}</wcm-text>` : (0,lit/* html */.dy)`<slot></slot>`;
    return (0,lit/* html */.dy)`<header class="${o(classes)}">${backBtn ? this.backBtnTemplate() : null} ${content} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
  }
};
...
WcmModalHeader = __decorateClass$r([
  (0,decorators/* customElement */.Mo)("wcm-modal-header")
], WcmModalHeader);
...
const styles$m = (0,lit/* css */.iv)`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
...
let WcmModalRouter = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
  ...
  viewTemplate() {
    switch (this.view) {
      case "ConnectWallet":
        return (0,lit/* html */.dy)`<wcm-connect-wallet-view></wcm-connect-wallet-view>`;
      case "DesktopConnecting":
        return (0,lit/* html */.dy)`<wcm-desktop-connecting-view></wcm-desktop-connecting-view>`;
      case "MobileConnecting":
        return (0,lit/* html */.dy)`<wcm-mobile-connecting-view></wcm-mobile-connecting-view>`;
      case "WebConnecting":
        return (0,lit/* html */.dy)`<wcm-web-connecting-view></wcm-web-connecting-view>`;
      case "MobileQrcodeConnecting":
        return (0,lit/* html */.dy)`<wcm-mobile-qr-connecting-view></wcm-mobile-qr-connecting-view>`;
      case "WalletExplorer":
        return (0,lit/* html */.dy)`<wcm-wallet-explorer-view></wcm-wallet-explorer-view>`;
      case "Qrcode":
        return (0,lit/* html */.dy)`<wcm-qrcode-view></wcm-qrcode-view>`;
      case "InstallWallet":
        return (0,lit/* html */.dy)`<wcm-install-wallet-view></wcm-install-wallet-view>`;
      default:
        return (0,lit/* html */.dy)`<div>Not Found</div>`;
    }
  }
  async onChangeRoute() {
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<div class="wcm-router"><div class="wcm-content">${this.viewTemplate()}</div></div>`;
  }
};
...
WcmModalRouter = __decorateClass$q([
  (0,decorators/* customElement */.Mo)("wcm-modal-router")
], WcmModalRouter);

const styles$l = (0,lit/* css */.iv)`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
...
let WcmModalToast = class extends lit/* LitElement */.oi {
  constructor() {
    super();
    this.open = false;
    // -- private ------------------------------------------------------ //
  ...
  render() {
    ...
    return this.open ? (0,lit/* html */.dy)`<div class="${o(classes)}">${variant === "success" ? SvgUtil.CHECKMARK_ICON : null} ${variant === "error" ? SvgUtil.CROSS_ICON : null}<wcm-text variant="small-regular">${message}</wcm-text></div>` : null;
  }
};
...
WcmModalToast = __decorateClass$p([
  (0,decorators/* customElement */.Mo)("wcm-modal-toast")
], WcmModalToast);
  ...
  generate(uri, size, logoSize) {
    ...
    qrList.forEach(({ x, y }) => {
      ...
      for (let i = 0; i < qrList.length; i += 1) {
        ...
        dots.push(
          (0,lit/* svg */.YP)`<rect fill="${i % 2 === 0 ? dotColor : edgeColor}" height="${dotSize}" rx="${dotSize * borderRadius}" ry="${dotSize * borderRadius}" width="${dotSize}" x="${x1 + cellSize * i}" y="${y1 + cellSize * i}">`
        );
      }
    });
    ...
    Object.entries(circlesToConnect).map(([cx, cys]) => {
      ...
      cys.forEach((cy) => {
        dots.push(
          (0,lit/* svg */.YP)`<circle cx="${cx}" cy="${cy}" fill="${dotColor}" r="${cellSize / CIRCLE_SIZE_MODIFIER}">`
        );
      });
    });
    Object.entries(circlesToConnect).filter(([_, cys]) => cys.length > 1).map(([cx, cys]) => {
      ...
      groups.forEach(([y1, y2]) => {
        dots.push(
          (0,lit/* svg */.YP)`<line x1="${cx}" x2="${cx}" y1="${y1}" y2="${y2}" stroke="${dotColor}" stroke-width="${cellSize / (CIRCLE_SIZE_MODIFIER / 2)}" stroke-linecap="round">`
        );
      });
    });
    return dots;
...
let WcmQrCode = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.uri = "";
    this.size = 0;
  ...
  svgTemplate() {
    ...
    return (0,lit/* svg */.YP)`<svg height="${size}" width="${size}">${QrCodeUtil.generate(this.uri, size, size / 4)}</svg>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    const classes = {
    ...
    return (0,lit/* html */.dy)`<div style="${`width: ${this.size}px`}" class="${o(classes)}">${this.walletId || this.imageUrl ? (0,lit/* html */.dy)`<wcm-wallet-image walletId="${l(this.walletId)}" imageId="${l(this.imageId)}" imageUrl="${l(this.imageUrl)}"></wcm-wallet-image>` : SvgUtil.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`;
  }
};
...
let WcmSearchInput = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.onChange = () => null;
  }
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${SvgUtil.SEARCH_ICON}`;
  }
};
...
WcmSearchInput = __decorateClass$n([
  (0,decorators/* customElement */.Mo)("wcm-search-input")
], WcmSearchInput);

const styles$i = (0,lit/* css */.iv)`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
...
let WcmText = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<span><slot class="${o(classes)}"></slot></span>`;
  }
};
...
WcmText = __decorateClass$l([
  (0,decorators/* customElement */.Mo)("wcm-text")
], WcmText);

const styles$g = (0,lit/* css */.iv)`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
...
let WcmWalletButton = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.onClick = () => null;
    this.name = "";
  ...
  sublabelTemplate() {
    if (this.recent) {
      return (0,lit/* html */.dy)`<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">RECENT</wcm-text>`;
    } else if (this.installed) {
      return (0,lit/* html */.dy)`<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">INSTALLED</wcm-text>`;
    }
    return null;
  }
  handleClick() {
  ...
  render() {
    var _a;
    return (0,lit/* html */.dy)`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${this.walletId}" imageId="${l(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${(_a = this.label) != null ? _a : UiUtil.getWalletName(this.name, true)}</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
...
WcmWalletButton = __decorateClass$k([
  (0,decorators/* customElement */.Mo)("wcm-wallet-button")
], WcmWalletButton);

const styles$f = (0,lit/* css */.iv)`:host{display:block}div{overflow:hidden;position:relative;border-radius:inherit;width:100%;height:100%;background-color:var(--wcm-color-overlay)}svg{position:relative;width:100%;height:100%}div::after{content:'';position:absolute;top:0;bottom:0;left:0;right:0;border-radius:inherit;border:1px solid var(--wcm-color-overlay)}div img{width:100%;height:100%;object-fit:cover;object-position:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
let WcmWalletImage = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.walletId = "";
    this.imageId = void 0;
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`${src.length ? (0,lit/* html */.dy)`<div><img crossorigin="anonymous" src="${src}" alt="${this.id}"></div>` : SvgUtil.WALLET_PLACEHOLDER}`;
  }
};
...
WcmWalletImage = __decorateClass$j([
  (0,decorators/* customElement */.Mo)("wcm-wallet-image")
], WcmWalletImage);
...
let WcmExplorerContext = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    this.preload = true;
...
WcmExplorerContext = __decorateClass$i([
  (0,decorators/* customElement */.Mo)("wcm-explorer-context")
], WcmExplorerContext);
...
let WcmThemeContext = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    // -- private ------------------------------------------------------ //
...
let WcmAndroidWalletSelection = class extends lit/* LitElement */.oi {
  // -- private ------------------------------------------------------ //
  onGoToQrcode() {
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<wcm-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${SvgUtil.QRCODE_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-title">${SvgUtil.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">WalletConnect</wcm-text></div><div class="wcm-slider"><div class="wcm-track">${[...Array(recomendedCount)].map((_, index) => {
      const wallet = wallets[index % wallets.length];
      return wallet ? (0,lit/* html */.dy)`<wcm-wallet-image walletId="${wallet.id}" imageId="${wallet.image_id}"></wcm-wallet-image>` : SvgUtil.WALLET_PLACEHOLDER;
...
let WcmConnectorWaiting = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.walletId = void 0;
    this.imageId = void 0;
  ...
  svgLoaderTemplate() {
    ...
    return (0,lit/* html */.dy)`<svg viewBox="0 0 110 110" width="110" height="110"><rect id="wcm-loader" x="2" y="2" width="106" height="106" rx="${numRadius}"/><use xlink:href="#wcm-loader" stroke-dasharray="106 ${dashArray}" stroke-dashoffset="${dashOffset}"></use></svg>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    const classes = {
    ...
    return (0,lit/* html */.dy)`<div class="${o(classes)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${l(this.walletId)}" imageId="${l(this.imageId)}"></wcm-wallet-image></div><wcm-text variant="medium-regular" color="${this.isError ? "error" : "primary"}">${this.isError ? "Connection declined" : this.label}</wcm-text>`;
  }
};
...
WcmConnectorWaiting = __decorateClass$f([
  (0,decorators/* customElement */.Mo)("wcm-connector-waiting")
], WcmConnectorWaiting);
...
const TemplateUtil = {
  ...
  manualWalletsTemplate() {
    ...
    return wallets.map(
      (wallet) => (0,lit/* html */.dy)`<wcm-wallet-button walletId="${wallet.id}" name="${wallet.name}" .onClick="${() => this.onConnecting(wallet)}"></wcm-wallet-button>`
    );
  },
  recomendedWalletsTemplate(skipRecent = false) {
    const wallets = DataUtil.recomendedWallets(skipRecent);
    return wallets.map(
      (wallet) => (0,lit/* html */.dy)`<wcm-wallet-button name="${wallet.name}" walletId="${wallet.id}" imageId="${wallet.image_id}" .onClick="${() => this.onConnecting(wallet)}"></wcm-wallet-button>`
    );
  },
  recentWalletTemplate() {
    ...
    return (0,lit/* html */.dy)`<wcm-wallet-button name="${wallet.name}" walletId="${wallet.id}" imageId="${l(wallet.image_id)}" .recent="${true}" .onClick="${() => this.onConnecting(wallet)}"></wcm-wallet-button>`;
  }
};

const styles$c = (0,lit/* css */.iv)`.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
...
let WcmDesktopWalletSelection = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    ...
    return (0,lit/* html */.dy)`<wcm-modal-header .border="${true}" title="Connect your wallet" .onAction="${UiUtil.handleUriCopy}" .actionIcon="${SvgUtil.COPY_ICON}"></wcm-modal-header><wcm-modal-content><div class="wcm-mobile-title"><div class="wcm-subtitle">${SvgUtil.MOBILE_ICON}<wcm-text variant="small-regular" color="accent">Mobile</wcm-text></div><div class="wcm-subtitle">${SvgUtil.SCAN_ICON}<wcm-text variant="small-regular" color="secondary">Scan with your wallet</wcm-text></div></div><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>${isWallets ? (0,lit/* html */.dy)`<wcm-modal-footer><div class="wcm-desktop-title">${SvgUtil.DESKTOP_ICON}<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${wallets} ${isViewAll ? (0,lit/* html */.dy)`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-footer>` : null}`;
  }
};
WcmDesktopWalletSelection.styles = [ThemeUtil.globalCss, styles$c];
WcmDesktopWalletSelection = __decorateClass$e([
  (0,decorators/* customElement */.Mo)("wcm-desktop-wallet-selection")
], WcmDesktopWalletSelection);

const styles$b = (0,lit/* css */.iv)`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
...
let WcmLegalNotice = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    ...
    return (0,lit/* html */.dy)`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${termsOfServiceUrl ? (0,lit/* html */.dy)`<a href="${termsOfServiceUrl}" target="_blank" rel="noopener noreferrer">Terms of Service</a>` : null} ${termsOfServiceUrl && privacyPolicyUrl ? "and" : null} ${privacyPolicyUrl ? (0,lit/* html */.dy)`<a href="${privacyPolicyUrl}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>` : null}</wcm-text></div>`;
  }
};
WcmLegalNotice.styles = [ThemeUtil.globalCss, styles$b];
WcmLegalNotice = __decorateClass$d([
  (0,decorators/* customElement */.Mo)("wcm-legal-notice")
], WcmLegalNotice);

const styles$a = (0,lit/* css */.iv)`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
...
let WcmMobileWalletSelection = class extends lit/* LitElement */.oi {
  // -- private ------------------------------------------------------ //
  onQrcode() {
    dist/* RouterCtrl */.AV.push("Qrcode");
  }
  ...
  render() {
    ...
    const isWallets = Boolean(wallets.length);
    return (0,lit/* html */.dy)`<wcm-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${SvgUtil.QRCODE_ICON}"></wcm-modal-header>${isWallets ? (0,lit/* html */.dy)`<wcm-modal-content><div>${wallets} ${isViewAll ? (0,lit/* html */.dy)`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null}</div></wcm-modal-content>` : null}`;
  }
};
WcmMobileWalletSelection.styles = [ThemeUtil.globalCss, styles$a];
WcmMobileWalletSelection = __decorateClass$c([
  (0,decorators/* customElement */.Mo)("wcm-mobile-wallet-selection")
], WcmMobileWalletSelection);

const styles$9 = (0,lit/* css */.iv)`:host{all:initial}.wcm-overlay{top:0;bottom:0;left:0;right:0;position:fixed;z-index:var(--wcm-z-index);overflow:hidden;display:flex;justify-content:center;align-items:center;opacity:0;pointer-events:none;background-color:var(--wcm-overlay-background-color);backdrop-filter:var(--wcm-overlay-backdrop-filter)}@media(max-height:720px) and (orientation:landscape){.wcm-overlay{overflow:scroll;align-items:flex-start;padding:20px 0}}.wcm-active{pointer-events:auto}.wcm-container{position:relative;max-width:360px;width:100%;outline:0;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) var(--wcm-container-border-radius) var(--wcm-container-border-radius);border:1px solid var(--wcm-color-overlay);overflow:hidden}.wcm-card{width:100%;position:relative;border-radius:var(--wcm-container-border-radius);overflow:hidden;box-shadow:0 6px 14px -6px rgba(10,16,31,.12),0 10px 32px -4px rgba(10,16,31,.1),0 0 0 1px var(--wcm-color-overlay);background-color:var(--wcm-color-bg-1);color:var(--wcm-color-fg-1)}@media(max-width:600px){.wcm-container{max-width:440px;border-radius:var(--wcm-background-border-radius) var(--wcm-background-border-radius) 0 0}.wcm-card{border-radius:var(--wcm-container-border-radius) var(--wcm-container-border-radius) 0 0}.wcm-overlay{align-items:flex-end}}@media(max-width:440px){.wcm-container{border:0}}`;
...
let WcmModal = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    this.open = false;
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${o(classes)}" @click="${this.onCloseModal}" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${this.open ? (0,lit/* html */.dy)`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>` : null}</div></div>`;
  }
};
...
WcmModal = __decorateClass$b([
  (0,decorators/* customElement */.Mo)("wcm-modal")
], WcmModal);

const styles$8 = (0,lit/* css */.iv)`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
...
let WcmPlatformSelection = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
    this.isMobile = false;
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<div>${this.isRetry ? (0,lit/* html */.dy)`<slot></slot>` : null} ${this.isMobile ? (0,lit/* html */.dy)`<wcm-button .onClick="${this.onMobile}" .iconLeft="${SvgUtil.MOBILE_ICON}" variant="outline">Mobile</wcm-button>` : null} ${this.isDesktop ? (0,lit/* html */.dy)`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${SvgUtil.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>` : null} ${this.isWeb ? (0,lit/* html */.dy)`<wcm-button .onClick="${this.onWeb}" .iconLeft="${SvgUtil.GLOBE_ICON}" variant="outline">Web</wcm-button>` : null}</div>`;
  }
};
...
WcmPlatformSelection = __decorateClass$a([
  (0,decorators/* customElement */.Mo)("wcm-platform-selection")
], WcmPlatformSelection);

const styles$7 = (0,lit/* css */.iv)`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
...
let WcmViewAllWalletsButton = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  onClick() {
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<button @click="${this.onClick}"><div class="wcm-icons">${reversedWallets.map((wallet) => {
      const explorerImg = UiUtil.getWalletIcon(wallet);
      if (explorerImg) {
        return (0,lit/* html */.dy)`<img crossorigin="anonymous" src="${explorerImg}">`;
      }
      const src = UiUtil.getWalletIcon({ id: wallet.id });
      return src ? (0,lit/* html */.dy)`<img crossorigin="anonymous" src="${src}">` : SvgUtil.WALLET_PLACEHOLDER;
...
WcmViewAllWalletsButton = __decorateClass$9([
  (0,decorators/* customElement */.Mo)("wcm-view-all-wallets-button")
], WcmViewAllWalletsButton);

const styles$6 = (0,lit/* css */.iv)`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
...
let WcmWalletConnectQr = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    this.walletId = "";
  ...
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<div class="wcm-qr-container">${this.uri ? (0,lit/* html */.dy)`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${l(this.walletId)}" imageId="${l(this.imageId)}"></wcm-qrcode>` : (0,lit/* html */.dy)`<wcm-spinner></wcm-spinner>`}</div>`;
  }
};
...
WcmWalletConnectQr = __decorateClass$8([
  (0,decorators/* customElement */.Mo)("wcm-walletconnect-qr")
], WcmWalletConnectQr);
...
let WcmConnectWalletView = class extends lit/* LitElement */.oi {
  // -- private ------------------------------------------------------ //
  viewTemplate() {
    if (dist/* CoreUtil */.zv.isAndroid() && !dist/* CoreUtil */.zv.isTelegram()) {
      return (0,lit/* html */.dy)`<wcm-android-wallet-selection></wcm-android-wallet-selection>`;
    }
    if (dist/* CoreUtil */.zv.isMobile()) {
      return (0,lit/* html */.dy)`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>`;
    }
    return (0,lit/* html */.dy)`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
  }
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`${this.viewTemplate()}<wcm-legal-notice></wcm-legal-notice>`;
  }
};
WcmConnectWalletView.styles = [ThemeUtil.globalCss];
WcmConnectWalletView = __decorateClass$7([
  (0,decorators/* customElement */.Mo)("wcm-connect-wallet-view")
], WcmConnectWalletView);

const styles$5 = (0,lit/* css */.iv)`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
let WcmDesktopConnectingView = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    this.isError = false;
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<wcm-modal-header title="${name}" .onAction="${UiUtil.handleUriCopy}" .actionIcon="${SvgUtil.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${id}" imageId="${l(image_id)}" label="${`Continue in ${name}...`}" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Connection can continue loading if ${name} is not installed on your device`}</wcm-text><wcm-platform-selection .isMobile="${isMobile}" .isWeb="${isWeb}" .isRetry="${true}"><wcm-button .onClick="${this.openDesktopApp.bind(this)}" .iconRight="${SvgUtil.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
...
WcmDesktopConnectingView = __decorateClass$6([
  (0,decorators/* customElement */.Mo)("wcm-desktop-connecting-view")
], WcmDesktopConnectingView);

const styles$4 = (0,lit/* css */.iv)`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
...
let WcmInstallWalletView = class extends lit/* LitElement */.oi {
  // -- private ------------------------------------------------------ //
  onInstall(uri) {
    if (uri) {
...
let WcmMobileConnectingView = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    this.isError = false;
  ...
  render() {
    ...
    const universalUrl = mobile == null ? void 0 : mobile.universal;
    return (0,lit/* html */.dy)`<wcm-modal-header title="${name}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${id}" imageId="${l(image_id)}" label="Tap 'Open' to continue…" .isError="${this.isError}"></wcm-connector-waiting></wcm-modal-content><wcm-info-footer class="wcm-note"><wcm-platform-selection .isWeb="${isWeb}" .isRetry="${true}"><wcm-button .onClick="${() => this.openMobileApp(false)}" .iconRight="${SvgUtil.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection>${universalUrl ? (0,lit/* html */.dy)`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() => this.openMobileApp(true)}">Try this alternate link</span></wcm-text>` : null}</wcm-info-footer><wcm-info-footer class="wcm-app-store"><div><wcm-wallet-image walletId="${id}" imageId="${l(image_id)}"></wcm-wallet-image><wcm-text>${`Get ${name}`}</wcm-text></div><wcm-button .iconRight="${SvgUtil.ARROW_RIGHT_ICON}" .onClick="${() => this.onGoToAppStore(downloadUrl)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
...
WcmMobileConnectingView = __decorateClass$4([
  (0,decorators/* customElement */.Mo)("wcm-mobile-connecting-view")
], WcmMobileConnectingView);

const styles$2 = (0,lit/* css */.iv)`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
let WcmMobileQrConnectingView = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    const { name, id, image_id } = dist/* CoreUtil */.zv.getWalletRouterData();
    const { isDesktop, isWeb } = UiUtil.getCachedRouterWalletPlatforms();
    return (0,lit/* html */.dy)`<wcm-modal-header title="${name}" .onAction="${UiUtil.handleUriCopy}" .actionIcon="${SvgUtil.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr walletId="${id}" imageId="${l(image_id)}"></wcm-walletconnect-qr></wcm-modal-content><wcm-info-footer><wcm-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${name} app`}</wcm-text><wcm-platform-selection .isDesktop="${isDesktop}" .isWeb="${isWeb}"></wcm-platform-selection></wcm-info-footer>`;
  }
};
WcmMobileQrConnectingView.styles = [ThemeUtil.globalCss, styles$2];
WcmMobileQrConnectingView = __decorateClass$3([
  (0,decorators/* customElement */.Mo)("wcm-mobile-qr-connecting-view")
...
let WcmQrcodeView = class extends lit/* LitElement */.oi {
  // -- render ------------------------------------------------------- //
  render() {
    return (0,lit/* html */.dy)`<wcm-modal-header title="Scan the code" .onAction="${UiUtil.handleUriCopy}" .actionIcon="${SvgUtil.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
  }
};
WcmQrcodeView.styles = [ThemeUtil.globalCss];
WcmQrcodeView = __decorateClass$2([
  (0,decorators/* customElement */.Mo)("wcm-qrcode-view")
], WcmQrcodeView);

const styles$1 = (0,lit/* css */.iv)`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
...
let WcmWalletExplorerView = class extends lit/* LitElement */.oi {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return (0,lit/* html */.dy)`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(this)}"></wcm-search-input></wcm-modal-header><wcm-modal-content class="${o(classes)}"><div class="wcm-grid">${isLoading ? null : manualWallets} ${isLoading ? null : recomendedWallets} ${isLoading ? null : listings.map(
      (listing) => (0,lit/* html */.dy)`${listing ? (0,lit/* html */.dy)`<wcm-wallet-button imageId="${listing.image_id}" name="${listing.name}" walletId="${listing.id}" .onClick="${() => this.onConnect(listing)}"></wcm-wallet-button>` : null}`
    )}</div><div class="wcm-placeholder-block">${isEmpty ? (0,lit/* html */.dy)`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null} ${!isEmpty && this.loading ? (0,lit/* html */.dy)`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
...
WcmWalletExplorerView = __decorateClass$1([
  (0,decorators/* customElement */.Mo)("wcm-wallet-explorer-view")
], WcmWalletExplorerView);

const styles = (0,lit/* css */.iv)`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
...
let WcmWebConnectingView = class extends lit/* LitElement */.oi {
  // -- lifecycle ---------------------------------------------------- //
  constructor() {
    super();
    this.isError = false;
...
WcmWebConnectingView = __decorateClass([
  (0,decorators/* customElement */.Mo)("wcm-web-connecting-view")
...
// UNUSED EXPORTS: CSSResult, UpdatingElement, _$LE, _$LH, adoptStyles, defaultConverter, getCompatibleStyle, isServer, noChange, notEqual, nothing, supportsAdoptingStyleSheets, unsafeCSS
