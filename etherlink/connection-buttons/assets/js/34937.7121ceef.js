...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ QRCode_QRCodeRenderer)
});
...
;// CONCATENATED MODULE: ./node_modules/uqr/dist/index.mjs
...
;// CONCATENATED MODULE: ./node_modules/thirdweb/dist/esm/react/web/ui/components/QRCode/QRCodeRenderer.js
"use client";
...
function QRCodeRenderer({ ecl = "M", size: sizeProp = 200, uri, clearSize = 0, image, imageBackground = "transparent", }) {
    ...
    const dots = (0,react.useMemo)(() => {
        ...
        for (const { x, y } of qrList) {
            ...
            for (let i = 0; i < 3; i++) {
                dotsArray.push((0,jsx_runtime.jsx)("rect", { fill: i % 2 !== 0
        ...
        if (image) {
            ...
            dotsArray.push((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)("rect", { fill: imageBackground, rx: (0 - 2) * -5 + 2, ry: (0 - 2) * -5 + 2, width: cellSize * (7 - 0 * 2), height: cellSize * (7 - 0 * 2), x: x1 + cellSize * 0, y: y1 + cellSize * 0 }), (0,jsx_runtime.jsx)("foreignObject", { width: cellSize * (7 - 0 * 2), height: cellSize * (7 - 0 * 2), x: x1 + cellSize * 0, y: y1 + cellSize * 0, children: (0,jsx_runtime.jsx)("div", { style: { borderRadius: (0 - 2) * -5 + 2, overflow: "hidden" }, children: image }) })] }));
        }
                    ...
                    if (!((i < 7 && j < 7) ||
                        ...
                        if (image ||
                            !(i > matrixMiddleStart &&
                                ...
                                j > matrixMiddleStart &&
                                j < matrixMiddleEnd)) {
                            dotsArray.push((0,jsx_runtime.jsx)("circle", { cx: i * cellSize + cellSize / 2, cy: j * cellSize + cellSize / 2, fill: "var(--ck-qr-dot-color)", r: cellSize / 3 }, `circle-${i}-${
    ...
    return ((0,jsx_runtime.jsxs)("svg", { height: size, width: size, viewBox: `0 0 ${size} ${size}`, style: {
            width: size,
            height: size,
        }, role: "presentation", children: [(0,jsx_runtime.jsx)("rect", { fill: "transparent", height: size, width: size }), dots] }));
}
/* harmony default export */ const QRCode_QRCodeRenderer = (QRCodeRenderer);
