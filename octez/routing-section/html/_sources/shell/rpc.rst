...
* /
  ...
  * /bls
    ...
    * /bls/aggregate_proofs (`POST <POST_--bls--aggregate_proofs_>`_)
    
    * /bls/aggregate_public_keys (`POST <POST_--bls--aggregate_public_keys_>`_)
    
    * /bls/aggregate_signatures (`POST <POST_--bls--aggregate_signatures_>`_)
    
    * /bls/check_proof (`POST <POST_--bls--check_proof_>`_)
    
    * /bls/threshold_signatures (`POST <POST_--bls--threshold_signatures_>`_)
  
  * /chains
    
    * /chains/<chain_id> (`PATCH <PATCH_--chains--chain_id_>`_)
      
      * /chains/<chain_id>/active_peers_heads (`GET <GET_--chains--chain_id--active_peers_heads_>`_)
      ...
      * /chains/<chain_id>/delegators_contribution
        
        * /chains/<chain_id>/delegators_contribution/<int32>
          
          * /chains/<chain_id>/delegators_contribution/<int32>/<pkh> (`GET <GET_--chains--chain_id--delegators_contribution--int32--pkh_>`_)
      ...
      * /chains/<chain_id>/protocols (`GET <GET_--chains--chain_id--protocols_>`_)
        
        * /chains/<chain_id>/protocols/<Protocol_hash> (`GET <GET_--chains--chain_id--protocols--Protocol_hash_>`_)
  ...
  * /network
    ...
    * /network/full_stat (`GET <GET_--network--full_stat_>`_)
...
.. _POST_--bls--aggregate_proofs :

**POST /bls/aggregate_proofs**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'POST_--bls--aggregate_proofsdescr', 'POST_--bls--aggregate_proofs')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_proofsinput.json', 'POST_--bls--aggregate_proofs')">Json input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_proofsinput.bin', 'POST_--bls--aggregate_proofs')">Binary input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_proofsoutput.json', 'POST_--bls--aggregate_proofs')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_proofsoutput.bin', 'POST_--bls--aggregate_proofs')">Binary output</button>
    </div><div id="POST_--bls--aggregate_proofsdescr" class="POST_--bls--aggregate_proofs tabcontent">
            <p>
            Aggregate BLS proofs. Return null if the provided proofs cannot be aggregated, or if their aggregation is not a valid proof for the provided public key.</p>
            </div>
  <div id="POST_--bls--aggregate_proofsinput.json" class="POST_--bls--aggregate_proofs tabcontent">
    <pre>
    { "public_key": $Bls12_381.Public_key,
      "proofs": [ $Bls12_381_signature ... ] }
  ...
  <div id="POST_--bls--aggregate_proofsinput.bin" class="POST_--bls--aggregate_proofs tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    | public_key            | 48 bytes | bytes                              |
    +-----------------------+----------+------------------------------------+
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | proofs                | Variable | sequence of bytes                  |
    +-----------------------+----------+------------------------------------+
    
    
    </pre>
    </div>
  <div id="POST_--bls--aggregate_proofsoutput.json" class="POST_--bls--aggregate_proofs tabcontent">
    <pre>
    $Bls12_381_signature /* Some */ || null /* None */
    $Bls12_381_signature:
      /* A Bls12_381 signature (Base58Check-encoded) */
      $unistring
    $unistring:
  ...
  <div id="POST_--bls--aggregate_proofsoutput.bin" class="POST_--bls--aggregate_proofs tabcontent">
    <pre>
    +-----------------+----------------------+----------+
    | Name            | Size                 | Contents |
    +=================+======================+==========+
...
.. _POST_--bls--aggregate_public_keys :

**POST /bls/aggregate_public_keys**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'POST_--bls--aggregate_public_keysdescr', 'POST_--bls--aggregate_public_keys')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_public_keysinput.json', 'POST_--bls--aggregate_public_keys')">Json input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_public_keysinput.bin', 'POST_--bls--aggregate_public_keys')">Binary input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_public_keysoutput.json', 'POST_--bls--aggregate_public_keys')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_public_keysoutput.bin', 'POST_--bls--aggregate_public_keys')">Binary output</button>
    </div><div id="POST_--bls--aggregate_public_keysdescr" class="POST_--bls--aggregate_public_keys tabcontent">
            <p>
            Aggregate BLS public keys after checking their BLS proofs</p>
            </div>
  <div id="POST_--bls--aggregate_public_keysinput.json" class="POST_--bls--aggregate_public_keys tabcontent">
    <pre>
    [ { "public_key": $Bls12_381.Public_key,
  ...
  <div id="POST_--bls--aggregate_public_keysinput.bin" class="POST_--bls--aggregate_public_keys tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    ...
    ***
    ...
    | public_key | 48 bytes | bytes    |
    +------------+----------+----------+
    | proof      | 96 bytes | bytes    |
    +------------+----------+----------+
    
    </pre>
    </div>
  <div id="POST_--bls--aggregate_public_keysoutput.json" class="POST_--bls--aggregate_public_keys tabcontent">
    <pre>
    { /* Some */
      "public_key": $Bls12_381.Public_key,
      "public_key_hash": $Bls12_381.Public_key_hash }
    || null
    /* None */
    $Bls12_381.Public_key:
      /* A Bls12_381 public key (Base58Check-encoded) */
  ...
  <div id="POST_--bls--aggregate_public_keysoutput.bin" class="POST_--bls--aggregate_public_keys tabcontent">
    <pre>
    +-----------------+----------------------+----------+
    | Name            | Size                 | Contents |
    +=================+======================+==========+
...
.. _POST_--bls--aggregate_signatures :

**POST /bls/aggregate_signatures**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'POST_--bls--aggregate_signaturesdescr', 'POST_--bls--aggregate_signatures')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_signaturesinput.json', 'POST_--bls--aggregate_signatures')">Json input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_signaturesinput.bin', 'POST_--bls--aggregate_signatures')">Binary input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_signaturesoutput.json', 'POST_--bls--aggregate_signatures')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--aggregate_signaturesoutput.bin', 'POST_--bls--aggregate_signatures')">Binary output</button>
    </div><div id="POST_--bls--aggregate_signaturesdescr" class="POST_--bls--aggregate_signatures tabcontent">
            <p>
            Aggregate BLS signatures. Return null if the signatures cannot be aggregated, or if their aggregation is not a valid signature for the provided public key and message.</p>
            </div>
  <div id="POST_--bls--aggregate_signaturesinput.json" class="POST_--bls--aggregate_signatures tabcontent">
    <pre>
    { "public_key": $Bls12_381.Public_key,
      "message": /^([a-zA-Z0-9][a-zA-Z0-9])*$/,
      "signature_shares": [ $Bls12_381_signature ... ] }
    $Bls12_381.Public_key:
      /* A Bls12_381 public key (Base58Check-encoded) */
      $unistring
    $Bls12_381_signature:
  ...
  <div id="POST_--bls--aggregate_signaturesinput.bin" class="POST_--bls--aggregate_signatures tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    ...
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | signature_shares      | Variable | sequence of bytes                  |
    +-----------------------+----------+------------------------------------+
    
    
    </pre>
    </div>
  <div id="POST_--bls--aggregate_signaturesoutput.json" class="POST_--bls--aggregate_signatures tabcontent">
    <pre>
    $Bls12_381_signature /* Some */ || null /* None */
    $Bls12_381_signature:
      /* A Bls12_381 signature (Base58Check-encoded) */
  ...
  <div id="POST_--bls--aggregate_signaturesoutput.bin" class="POST_--bls--aggregate_signatures tabcontent">
    <pre>
    +-----------------+----------------------+----------+
    | Name            | Size                 | Contents |
    +=================+======================+==========+
...
.. _POST_--bls--check_proof :

**POST /bls/check_proof**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'POST_--bls--check_proofdescr', 'POST_--bls--check_proof')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--check_proofinput.json', 'POST_--bls--check_proof')">Json input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--check_proofinput.bin', 'POST_--bls--check_proof')">Binary input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--check_proofoutput.json', 'POST_--bls--check_proof')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--check_proofoutput.bin', 'POST_--bls--check_proof')">Binary output</button>
    </div><div id="POST_--bls--check_proofdescr" class="POST_--bls--check_proof tabcontent">
            <p>
            Check a BLS proof</p>
            </div>
  <div id="POST_--bls--check_proofinput.json" class="POST_--bls--check_proof tabcontent">
    <pre>
    { "public_key": $Bls12_381.Public_key,
      "proof": $Bls12_381_signature }
    $Bls12_381.Public_key:
  ...
  <div id="POST_--bls--check_proofinput.bin" class="POST_--bls--check_proof tabcontent">
    <pre>
    +------------+----------+----------+
    | Name       | Size     | Contents |
    +============+==========+==========+
  ...
  <div id="POST_--bls--check_proofoutput.json" class="POST_--bls--check_proof tabcontent">
    <pre>
    boolean</pre>
    </div>
  <div id="POST_--bls--check_proofoutput.bin" class="POST_--bls--check_proof tabcontent">
    <pre>
    +-----------------+--------+-------------------------------------+
    | Name            | Size   | Contents                            |
    +=================+========+=====================================+
...
.. _POST_--bls--threshold_signatures :

**POST /bls/threshold_signatures**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'POST_--bls--threshold_signaturesdescr', 'POST_--bls--threshold_signatures')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--threshold_signaturesinput.json', 'POST_--bls--threshold_signatures')">Json input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--threshold_signaturesinput.bin', 'POST_--bls--threshold_signatures')">Binary input</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--threshold_signaturesoutput.json', 'POST_--bls--threshold_signatures')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'POST_--bls--threshold_signaturesoutput.bin', 'POST_--bls--threshold_signatures')">Binary output</button>
    </div><div id="POST_--bls--threshold_signaturesdescr" class="POST_--bls--threshold_signatures tabcontent">
            <p>
            Threshold BLS signatures</p>
            </div>
  <div id="POST_--bls--threshold_signaturesinput.json" class="POST_--bls--threshold_signatures tabcontent">
    <pre>
    { "public_key": $Bls12_381.Public_key,
      "message": /^([a-zA-Z0-9][a-zA-Z0-9])*$/,
      "signature_shares":
  ...
  <div id="POST_--bls--threshold_signaturesinput.bin" class="POST_--bls--threshold_signatures tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    ...
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | signature_shares      | Variable | sequence of $X_0                   |
    +-----------------------+----------+------------------------------------+
    ...
    ***
    ...
    | Name      | Size     | Contents             |
    +===========+==========+======================+
    | id        | 1 byte   | signed 8-bit integer |
    +-----------+----------+----------------------+
    | signature | 96 bytes | bytes                |
    +-----------+----------+----------------------+
    
    </pre>
    </div>
  <div id="POST_--bls--threshold_signaturesoutput.json" class="POST_--bls--threshold_signatures tabcontent">
    <pre>
    $Bls12_381_signature /* Some */ || null /* None */
    $Bls12_381_signature:
      /* A Bls12_381 signature (Base58Check-encoded) */
  ...
  <div id="POST_--bls--threshold_signaturesoutput.bin" class="POST_--bls--threshold_signatures tabcontent">
    <pre>
    +-----------------+----------------------+----------+
    | Name            | Size                 | Contents |
    +=================+======================+==========+
...
.. _GET_--chains--chain_id--active_peers_heads :

**GET /chains/<chain_id>/active_peers_heads**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--chains--chain_id--active_peers_headsdescr', 'GET_--chains--chain_id--active_peers_heads')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--active_peers_headsoutput.json', 'GET_--chains--chain_id--active_peers_heads')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--active_peers_headsoutput.bin', 'GET_--chains--chain_id--active_peers_heads')">Binary output</button>
    </div><div id="GET_--chains--chain_id--active_peers_headsdescr" class="GET_--chains--chain_id--active_peers_heads tabcontent">
            <p>
            The heads of all active peers</p>
            </div>
  <div id="GET_--chains--chain_id--active_peers_headsoutput.json" class="GET_--chains--chain_id--active_peers_heads tabcontent">
    <pre>
    { "active_peers_heads":
        [ { "peer_id": $Crypto_box.Public_key_hash,
            "block_hash": $block_hash,
            "block_level": integer ∈ [-2^31-1, 2^31] } ... ] }
  ...
  <div id="GET_--chains--chain_id--active_peers_headsoutput.bin" class="GET_--chains--chain_id--active_peers_heads tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | active_peers_heads    | Variable | sequence of $X_0                   |
    +-----------------------+----------+------------------------------------+
    ...
    ***
    ...
    +-------------+----------+----------------------------------+
    | block_level | 4 bytes  | signed 32-bit big-endian integer |
    +-------------+----------+----------------------------------+
...
.. _GET_--chains--chain_id--delegators_contribution--int32--pkh :

**GET /chains/<chain_id>/delegators_contribution/<int32>/<pkh>**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--chains--chain_id--delegators_contribution--int32--pkhdescr', 'GET_--chains--chain_id--delegators_contribution--int32--pkh')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--delegators_contribution--int32--pkhoutput.json', 'GET_--chains--chain_id--delegators_contribution--int32--pkh')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--delegators_contribution--int32--pkhoutput.bin', 'GET_--chains--chain_id--delegators_contribution--int32--pkh')">Binary output</button>
    </div><div id="GET_--chains--chain_id--delegators_contribution--int32--pkhdescr" class="GET_--chains--chain_id--delegators_contribution--int32--pkh tabcontent">
            <p>
            A breakdown of all the contributions to the delegation portion of the baking power of the given delegate for the given cycle.</p>
            </div>
  <div id="GET_--chains--chain_id--delegators_contribution--int32--pkhoutput.json" class="GET_--chains--chain_id--delegators_contribution--int32--pkh tabcontent">
    <pre>
    { "own_delegated": $int64,
      "external_delegators":
        [ { "delegator_contract_hash": $unistring,
            "contribution": $int64 } ... ],
  ...
  <div id="GET_--chains--chain_id--delegators_contribution--int32--pkhoutput.bin" class="GET_--chains--chain_id--delegators_contribution--int32--pkh tabcontent">
    <pre>
    +-----------------------------------------+----------+------------------------------------+
    | Name                                    | Size     | Contents                           |
    +=========================================+==========+====================================+
    | own_delegated                           | 8 bytes  | signed 64-bit big-endian integer   |
    +-----------------------------------------+----------+------------------------------------+
    | # bytes in next field                   | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------------------------+----------+------------------------------------+
    | external_delegators                     | Variable | sequence of $X_0                   |
    +-----------------------------------------+----------+------------------------------------+
    | former_delegators_unstake_requests      | 8 bytes  | signed 64-bit big-endian integer   |
    +-----------------------------------------+----------+------------------------------------+
    | overstaked                              | 8 bytes  | signed 64-bit big-endian integer   |
    +-----------------------------------------+----------+------------------------------------+
    | total_delegated_including_overdelegated | 8 bytes  | signed 64-bit big-endian integer   |
    +-----------------------------------------+----------+------------------------------------+
    | total_delegated_after_limits            | 8 bytes  | signed 64-bit big-endian integer   |
    +-----------------------------------------+----------+------------------------------------+
    | overdelegated                           | 8 bytes  | signed 64-bit big-endian integer   |
    +-----------------------------------------+----------+------------------------------------+
    ...
    ***
    ...
    | # bytes in next field   | 4 bytes  | unsigned 30-bit big-endian integer |
    +-------------------------+----------+------------------------------------+
    | delegator_contract_hash | Variable | bytes                              |
    +-------------------------+----------+------------------------------------+
    | contribution            | 8 bytes  | signed 64-bit big-endian integer   |
    +-------------------------+----------+------------------------------------+
...
.. _GET_--chains--chain_id--protocols :

**GET /chains/<chain_id>/protocols**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--chains--chain_id--protocolsdescr', 'GET_--chains--chain_id--protocols')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--protocolsoutput.json', 'GET_--chains--chain_id--protocols')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--protocolsoutput.bin', 'GET_--chains--chain_id--protocols')">Binary output</button>
    </div><div id="GET_--chains--chain_id--protocolsdescr" class="GET_--chains--chain_id--protocols tabcontent">
            <p>
            Lists protocols of the chain.</p>
            </div>
  <div id="GET_--chains--chain_id--protocolsoutput.json" class="GET_--chains--chain_id--protocols tabcontent">
    <pre>
  ...
  <div id="GET_--chains--chain_id--protocolsoutput.bin" class="GET_--chains--chain_id--protocols tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    ...
    ***
    ...
    +------------------+----------+-------------------------------------------------------------------------+
    | proto_level      | 4 bytes  | signed 31-bit big-endian integer in the range -1073741824 to 1073741823 |
    +------------------+----------+-------------------------------------------------------------------------+
    | activation_block | 36 bytes | $X_1                                                                    |
    +------------------+----------+-------------------------------------------------------------------------+
...
.. _GET_--chains--chain_id--protocols--Protocol_hash :

**GET /chains/<chain_id>/protocols/<Protocol_hash>**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--chains--chain_id--protocols--Protocol_hashdescr', 'GET_--chains--chain_id--protocols--Protocol_hash')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--protocols--Protocol_hashoutput.json', 'GET_--chains--chain_id--protocols--Protocol_hash')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--chains--chain_id--protocols--Protocol_hashoutput.bin', 'GET_--chains--chain_id--protocols--Protocol_hash')">Binary output</button>
    </div><div id="GET_--chains--chain_id--protocols--Protocol_hashdescr" class="GET_--chains--chain_id--protocols--Protocol_hash tabcontent">
            <p>
            Information about a protocol of the chain.</p>
            </div>
  <div id="GET_--chains--chain_id--protocols--Protocol_hashoutput.json" class="GET_--chains--chain_id--protocols--Protocol_hash tabcontent">
    <pre>
    { "protocol": $Protocol_hash,
      "proto_level":
        integer ∈ [-2^30, 2^30]
  ...
  <div id="GET_--chains--chain_id--protocols--Protocol_hashoutput.bin" class="GET_--chains--chain_id--protocols--Protocol_hash tabcontent">
    <pre>
    +------------------+----------+-------------------------------------------------------------------------+
    | Name             | Size     | Contents                                                                |
    +==================+==========+=========================================================================+
...
.. raw:: html
  ...
  <div id="GET_--configoutput.bin" class="GET_--config tabcontent">
    ...
    ****
    ...
    +-----------------------------+----------------------+-----------------------------------------------------------+
    | advertises_level            | 1 byte               | boolean (0 for false, 255 for true)                       |
    +-----------------------------+----------------------+-----------------------------------------------------------+
...
.. _GET_--network--full_stat :

**GET /network/full_stat**

.. raw:: html
  
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--network--full_statdescr', 'GET_--network--full_stat')">Description</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--network--full_statoutput.json', 'GET_--network--full_stat')">Json output</button>
    <button class="tablinks" onclick="showTab(this, 'GET_--network--full_statoutput.bin', 'GET_--network--full_stat')">Binary output</button>
    </div><div id="GET_--network--full_statdescr" class="GET_--network--full_stat tabcontent">
            <p>
            Full network statistics.</p>
            </div>
  <div id="GET_--network--full_statoutput.json" class="GET_--network--full_stat tabcontent">
    <pre>
    { /* Stored statistics about the p2p network. */
      "stat": $p2p_stat,
      ...
      "points": [ [ $p2p_point.id, $p2p_point.info ] ... ] }
    $Crypto_box.Public_key_hash:
      /* A Cryptobox public key ID (Base58Check-encoded) */
      $unistring
    $bignum:
  ...
  <div id="GET_--network--full_statoutput.bin" class="GET_--network--full_stat tabcontent">
    <pre>
    +-----------------------+----------+------------------------------------+
    | Name                  | Size     | Contents                           |
    +=======================+==========+====================================+
    ...
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | incoming_connections  | Variable | sequence of $X_0                   |
    +-----------------------+----------+------------------------------------+
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | outgoing_connections  | Variable | sequence of $X_0                   |
    +-----------------------+----------+------------------------------------+
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | peers                 | Variable | sequence of $X_6                   |
    +-----------------------+----------+------------------------------------+
    | # bytes in next field | 4 bytes  | unsigned 30-bit big-endian integer |
    +-----------------------+----------+------------------------------------+
    | points                | Variable | sequence of $X_30                  |
    +-----------------------+----------+------------------------------------+
    ...
    ****
    ...
    | Name       | Size                 | Contents |
    +============+======================+==========+
    | sent       | Determined from data | $X_11    |
    +------------+----------------------+----------+
    | failed     | Determined from data | $X_11    |
    +------------+----------------------+----------+
    | received   | Determined from data | $X_11    |
    +------------+----------------------+----------+
    ...
    ****
    ...
    | failed    | Determined from data | $X_11    |
    +-----------+----------------------+----------+
    | scheduled | Determined from data | $X_11    |
    +-----------+----------------------+----------+
    ...
    ****
    ...
    | Name     | Size                 | Contents |
    +==========+======================+==========+
    | sent     | Determined from data | $X_22    |
    +----------+----------------------+----------+
    | received | Determined from data | $X_22    |
    +----------+----------------------+----------+
    ...
    ***
    ...
    | Name                     | Size                 | Contents |
    +==========================+======================+==========+
    | responses                | Determined from data | $X_10    |
    +--------------------------+----------------------+----------+
    | requests                 | Determined from data | $X_14    |
    +--------------------------+----------------------+----------+
    | valid_blocks             | Determined from data | $Z.t     |
    +--------------------------+----------------------+----------+
    | old_heads                | Determined from data | $Z.t     |
    +--------------------------+----------------------+----------+
    | prevalidator_results     | Determined from data | $X_19    |
    +--------------------------+----------------------+----------+
    ...
    +--------------------------+----------------------+----------+
    | unadvertised             | Determined from data | $X_20    |
    +--------------------------+----------------------+----------+
    | advertisements           | Determined from data | $X_21    |
    +--------------------------+----------------------+----------+
    ...
    ***
    ...
    +---------------------------------------------------+----------------------+---------------------------------------------------------------------+
    | conn_metadata                                     | 2 bytes              | $X_1                                                                |
    +---------------------------------------------------+----------------------+---------------------------------------------------------------------+
    | peer_metadata                                     | Determined from data | $X_9                                                                |
    +---------------------------------------------------+----------------------+---------------------------------------------------------------------+
    ...
    **************
    ...
    | ? presence of field "last_rejected_connection"    | 1 byte               | boolean (0 for false, 255 for true) |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | last_rejected_connection                          | 24 bytes             | $X_31                               |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | ? presence of field "last_established_connection" | 1 byte               | boolean (0 for false, 255 for true) |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | last_established_connection                       | 24 bytes             | $X_31                               |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | ? presence of field "last_disconnection"          | 1 byte               | boolean (0 for false, 255 for true) |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | last_disconnection                                | 24 bytes             | $X_31                               |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | ? presence of field "last_seen"                   | 1 byte               | boolean (0 for false, 255 for true) |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | last_seen                                         | 24 bytes             | $X_31                               |
    +---------------------------------------------------+----------------------+-------------------------------------+
    | ? presence of field "last_miss"                   | 1 byte               | boolean (0 for false, 255 for true) |
    +---------------------------------------------------+----------------------+-------------------------------------+
...
.. raw:: html
  ...
  <div id="GET_--profiler--registered_backendoutput.json" class="GET_--profiler--registered_backend tabcontent">
    ...
    { /* Registered backends. */
      "registered_backends":
        [ "opentelemetry" || "prometheus" || "plain_text" || "json" ... ],
  ...
  <div id="GET_--profiler--registered_backendoutput.bin" class="GET_--profiler--registered_backend tabcontent">
    ...
    | # bytes in next field                | 4 bytes  | unsigned 30-bit big-endian integer |
    +--------------------------------------+----------+------------------------------------+
    | registered_backends                  | Variable | sequence of $X_0                   |
    +--------------------------------------+----------+------------------------------------+
...
.. raw:: html
  ...
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--protocolsdescr', 'GET_--protocols')">Description</button>
    ...
    <button class="tablinks" onclick="showTab(this, 'GET_--protocolsoutput.bin', 'GET_--protocols')">Binary output</button>
            ...
            <p>
            the list of protocols supported by the node</p>
            </div>
...
.. raw:: html
  ...
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--protocols--Protocol_hashdescr', 'GET_--protocols--Protocol_hash')">Description</button>
    ...
    <button class="tablinks" onclick="showTab(this, 'GET_--protocols--Protocol_hashoutput.bin', 'GET_--protocols--Protocol_hash')">Binary output</button>
            ...
            <p>
            the interface of a protocol grouped by its implementing modules</p>
            </div>
...
.. raw:: html
  ...
  <div class="tab"><button class="tablinks defaultOpen" onclick="showTab(this, 'GET_--protocols--Protocol_hash--environmentdescr', 'GET_--protocols--Protocol_hash--environment')">Description</button>
    ...
    <button class="tablinks" onclick="showTab(this, 'GET_--protocols--Protocol_hash--environmentoutput.bin', 'GET_--protocols--Protocol_hash--environment')">Binary output</button>
            ...
            <p>
            the protocol environment version required by a protocol</p>
            </div>
