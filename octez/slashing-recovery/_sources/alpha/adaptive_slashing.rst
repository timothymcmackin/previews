...
For diagrams related to slashing, how the subsequent penalties affect
a delegate's baking rights, and how they can recover more quickly, see
:ref:`Recovering from being slashed<slashing_recovery_alpha>`.
...
.. _adaptive_slashing_informal_alpha:
...
.. _formal_adaptive_slashing_alpha:
